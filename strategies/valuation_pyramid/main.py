...
def generate_report(cerebro, strat, output_folder, benchmark_return, fetch_start_date, trading_start_date):
    ...
    lines.append(f"最大回撤: {strat.analyzers.drawdown.get_analysis()['max']['drawdown']:.2f}%")
...
if __name__ == '__main__':
    ...
    cerebro.addstrategy(ValuationStrategy, output_folder=out_dir, trade_start_date=config.START_DATE)
    ...
    generate_report(cerebro, strat, out_dir, bm_ret, fetch_start, config.START_DATE)
